    ...
    <Container showPassword={showPassword}>
        ...
        <div className='content'>
          ...
          <div className='body flex column a-center j-center'>
            ...
            <div className='form'>
              <input type='email' placeholder='Email Addres' name="email"value={formValues.email} onChange={(e)=>setFormValues({...formValues,[e.target.name]:e.target.value})}/>
              {
            ...
            <button onClick={handlegSignIn}>Sign Up</button>
          </div>
        </div>
    </Container>
  )
